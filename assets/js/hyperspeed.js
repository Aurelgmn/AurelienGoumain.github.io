// Port vanilla JS de https://reactbits.dev/components/hyperspeed
// Three.js + postprocessing chargés via esm.sh
...
import {
  ...
  SMAAEffect,
  SMAAPreset
} from 'https://esm.sh/postprocessing@6.35.6?deps=three@0.160';
...
export default function initHyperspeed(container, effectOptions = {}) {
  const options = {
  ...
  // Resolve distortion name to its object
  ...
  return () => {
    try { myApp.dispose(); } catch (e) { console.warn('Hyperspeed dispose:', e); }
  };
}
